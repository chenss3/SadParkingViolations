...
if (isset($_POST['updateviolationdata'])) {
    ...
    try
    {
        ...
        $prepared_stmt->bindValue(':violation_code', $var_violation_code, PDO::PARAM_STR);
        $prepared_stmt->bindValue(':violation_location', $var_violation_location, PDO::PARAM_STR);
        $prepared_stmt->bindValue(':violatin_precinct', $var_violation_precinct, PDO::PARAM_STR);
        ...
        $prepared_stmt->bindValue(':vilation_front_opposite', $var_violation_front_opposite, PDO::PARAM_STR);
